...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (!preg_match('/^[a-z\d]$/i', $_POST['firstname'])){
			$errors[] = "Nombres y apellidos solo llevan letras";
		} elseif (!preg_match('/^[a-z\d]$/i',$_POST['lastname'])){
			$errors[] = "Nombres y apellidos solo llevan letras";
            ...
            && !preg_match('/^[a-z\d]$/i', $_POST['firstname'])
			&& !empty($_POST['lastname'])
            && !preg_match('/^[a-z\d]$/i', $_POST['lasttname'])
